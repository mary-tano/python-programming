...
def initMenu() :
  ...
  #--
  Filemenu.add_command(label="Открыть", command=openFile, accelerator="Strg+O")
  Filemenu.add_command(label="Сохранить", command=saveFile, accelerator="Strg+S")
  Filemenu.add_command(label="Выход", command=closeAll, accelerator="Strg+X")
